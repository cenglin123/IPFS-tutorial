...
![y54B3.jpg](https://pic.cangku.moe/images/2025/05/20/y5ln2.jpg)

本文更多地址  
retry 网址以及编辑码  
https://rentry.org/ipfs_tutorial
...
也可以在这个由 [sandbox](https://cangku.moe/user/26977/post) 维护的网站中寻找更多可用的网关：
[https://rentry.org/ipfsnodes](https://rentry.org/ipfsnodes)
...
IPFS 的托管平台有很多，和 IPFS 的网关不同，这些托管平台大多数都没有被墙可直连，比如支付加密货币把文件托管给矿工的 [**Crust**](https://crust.network/) 以及基于 Crust 开发的 [**酸奶网盘**](https://cangku.moe/archives/212970) 、~~可以白嫖的 Chainsafe ，这里以后者 [https://app.storage.chainsafe.io/](https://app.storage.chainsafe.io/) 为例说明~~（chainsafe 已经于 20250401 跑路），以及目前免费的 Aleph。
...
本节内容**不是正经教程，而只是一个操作流程**，你不需要纠结其中任何操作的含义，只需要按照流程操作即可。
...
也可以通过比如 4everland.org 这样的平台来免费托管 IPNS 地址，具体可以参考[这篇文章](https://cangku.moe/archives/216179#heading-13)的第 3 节
...
> 8. **Crust 平台固定**：可以远程固定 CID 到 Crust 网络，通常用于固定聚合文件夹的 CID 来**分享大体积资源**。
...
IPFS 全称“**星际文件系统**”，既然是一个文件系统，自然是能够进行文件管理的，并且使用时的手感**非常类似秒传链接**。
...
本人在 [**之前的文章**](https://cangku.moe/archives/212002)[5] 中讨论过分享的几种安全级别，这里简要带过一下：
...
对于压缩包方案安全级别问题，我在 [**之前的文章**](https://cangku.moe/archives/212002)[5] 中已经讨论过，这里就不再赘述了，感兴趣可以参看我之前的文章，本文我想重点讨论一下 IPFS 方案的适用场景。
...
我之前在 [**这个实验**](https://cangku.moe/archives/211857)[6] 中讨论过，**百度网盘的审核机制其实并没有想象中那样严格**，对于不分享的显然违规的文件，百度网盘通常是不会管的；对于包含违规文件的分享压缩包，只要无法解密，百度网盘也是不会管的。总之，只要不能显式地定位到违规文件，百度网盘通常是不会管的。

这似乎和部分人的认知不符，百度明明就天天炸链，怎么能说不管呢？

根据 [**试验证据**](https://cangku.moe/archives/211893)[7] 表明，炸链的真实原因是：
...
（想要成功申诉需要注意隐写文件的伪装有效性问题，详情参考 [**隐写者软件的文章**](https://cangku.moe/archives/211602) ）。
...
[0] [[技巧分享] 防炸教程：如何安全分享资源？](https://cangku.moe/archives/215860)

[1] [[技巧分享] 用ipfs存储并分享文件](https://cangku.moe/archives/207441)

